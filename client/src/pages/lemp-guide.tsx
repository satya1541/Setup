...
import { Server, Clock, User, CheckCircle, ArrowLeft } from "lucide-react";
import { Link } from "wouter";

export default function LempGuide() {
          ...
          <div className="max-w-4xl mx-auto px-6 py-8">
            ...
            >
              ...
              <div className="relative p-8 md:p-12">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <div>
                    <h1 className="text-3xl md:text-4xl font-bold mb-2">LEMP Stack Setup Guide</h1>
                    <p className="text-xl opacity-90">Complete installation on Ubuntu 24.04</p>
                  </div>
                </div>
            ...
            {isAllCompleted && (
              ...
              >
                ...
                <p className="text-lg opacity-90 mb-4">You've successfully set up your LEMP stack!</p>
                <div className="bg-white/20 rounded-lg p-4 max-w-md mx-auto">
                  <p className="text-sm mb-2">Access phpMyAdmin at:</p>
                  <code className="text-lg font-mono">http://your-server-ip/phpmyadmin</code>
                  <div className="mt-3 pt-3 border-t border-white/20">
                    <p className="text-xs opacity-80">Login with: satya / satya123</p>
                  </div>
                </div>
              </motion.div>
            )}
